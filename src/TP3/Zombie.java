...
public class Zombie extends Creature{
    ...
    public Zombie(String nomComplet, String sexe, double poids, int taille, int age, int moralIndic, ArrayList<Maladie> listeMaladies) {
    ...
    @Override
    public void hurler() {
        System.out.print("Ma raison somnolait\n" +
